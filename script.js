...
// uncomment the below code if you want to execute function when the user hits the ENTER key
...
function checkValue(){
  ...
  if ( result > targetNum){
   ...
   $("#result").text("You got it!");
    ...
    $("#playerFeedback").html(`<h3>Nice job!<br/><br/>You guessed <u class="fw-bold text-success">${guesses.length}</u></span> time(s) before you won!<br/><br/>Refresh the page to play again.<h3>`);
